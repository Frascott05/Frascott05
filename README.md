...
- 🕵️ **Core Expertise**: Reverse Engineering, Malware Analysis & Development (Red Teaming), Penetration Testing, Volatile Memory Forensics, Cyber-Triage, and DFIR (Blue Teaming).
- ⚖️ **Legal & Compliance**: Specialized in Italian Penal Law & Criminal Procedure regarding Cybercrime, ISO/IEC 27037 standard compliance, and Chain of Custody preservation.
- 🏆 **CTF Player**: National Finalist in CyberChallenge.it (2022 & 2025), Olicyber 2023 Regional Champion, Team Italy Bootcamp Alumnus, and active CTF competitor (DefCon, M0leCon, Open ECSC).
...
- 🔬 **[SilenTrace](https://github.com/Frascott05/SilenTrace)**: An open-source post-incident RAM memory acquisition and forensic analysis tool designed for rapid incident triage.
- 🧩 **[Volatility3 Framework Contributor](https://github.com/Frascott05/volatility3)**: Active open-source contributor to the industry-standard Volatility 3 memory forensics framework.

---

### 🏆 Achievements & Certifications

*   🏅 **CyberChallenge.IT**: National Finalist (Editions 2022 & 2025)
*   🇮🇹 **Team Italy Bootcamp**: Italian National Cybersecurity Team Intensive Training Alumnus
*   🥉 **CyberCup 2024**: 2nd Place Team (*Team PWNCAM*)
*   🥇 **Olicyber 2023**: Regional Champion & National Finalist
*   🛡️ **Cyber Shield Response Exercise**: Conducted by *Leonardo*
*   📜 **Ethical Hacker Course**: Cisco Certified
*   🇬🇧 **Cambridge English Level 1 Certificate**: ESOL International (B2)

---

### 📫 Connect with Me

- 📧 **Email**: [Francesco2005scotti@gmail.com](mailto:Francesco2005scotti@gmail.com)
- 🐱 **GitHub**: [@Frascott05](https://github.com/Frascott05)
